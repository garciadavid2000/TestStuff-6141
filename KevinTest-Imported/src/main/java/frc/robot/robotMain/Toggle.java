 ...
 */
	...
	public class Toggle {
		...
		public Toggle(final Joystick joystick, final int port, final boolean start) {

		final JoystickButton button = new JoystickButton(joystick, port);
	...
	public void setToggle(final boolean value) {
			toggle = value;
		}
